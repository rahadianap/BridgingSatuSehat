...
class SearchPractitionerController extends Controller
{
    ...
    {   
        $url = Http::withToken($this->createToken())->get($this->getUrl().'/Practitioner?identifier=https://fhir.kemkes.go.id/id/nik|'.$nik);
